...
function(konanc_executable)
    ...
    add_custom_command(TARGET ${KONANC_NAME}.${EXECUTABLE_EXTENSION}
            PRE_LINK
            COMMAND ${CMAKE_COMMAND} -E copy ${KONANC_${KONANC_NAME}_EXECUTABLE_PATH}_TEMP.${EXECUTABLE_EXTENSION} ${CMAKE_CURRENT_BINARY_DIR}/${KONANC_NAME}.${EXECUTABLE_EXTENSION})

    if(${KONANC_TARGET} STREQUAL "wasm32")
        add_custom_command(TARGET ${KONANC_NAME}.${EXECUTABLE_EXTENSION}
                PRE_LINK
                COMMAND ${CMAKE_COMMAND} -E copy ${KONANC_${KONANC_NAME}_EXECUTABLE_PATH}_TEMP.${EXECUTABLE_EXTENSION}.js ${CMAKE_CURRENT_BINARY_DIR}/${KONANC_NAME}.${EXECUTABLE_EXTENSION}.js)
    endif()
